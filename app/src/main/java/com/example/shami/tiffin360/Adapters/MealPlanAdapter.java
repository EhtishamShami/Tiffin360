...
public class MealPlanAdapter extends  RecyclerView.Adapter<MealPlanAdapter.MealPlanAdapterViewHolder> {
    ...
    public void onBindViewHolder(final MealPlanAdapterViewHolder holder, final int position) {
        ...
        holder.mTitle.setText(mealData.get(position).getmTitle());
        holder.mDescription.setText(mealData.get(position).getmCustomField_Description());

       // Glide.with(mContext).load(mealData.get(position).getmCustomField_image()).into(holder.mImageView);
...
//        }
        ...
        holder.mImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Constants.slider_title,mealData.get(position).getmTitle());
